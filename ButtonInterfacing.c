...
int i=3;// initial value of global variable of i is = 3
...
void main(void) {
    ...
    { if ((RB0 ==1)&&(i==3))//if button is Pressed and the value of variable i is equal to 3 then 
    {while(RB0==1){RB2=1;RB3=0;// Turn ON the Relay connected to PIN RB2 and Turn OFF the LED COnnected to PIN RB3
        i=1;}// store the value to variable i = 1
        
    }
    if((RB0==1)&&(i==1))//if button is Pressed and the value of variable i is equal to 1 then 
        while(RB0==1){RB2=0;RB3=1;// Turn OFF the Relay connected to PIN RB2and Turn ON the LED COnnected to PIN RB3
            i=3;}// restore the value of variable i = 3
